...
const StyledModulePanel3 = styled.div<IStyledProps>`
  position: relative;
  border-radius: 6px;
...
const ModulePanel3: FC<IProps> = ({tooltip, result }): ReactElement => (
  <StyledModulePanel3>
    ...
    <div className="search-result__details">
        ...
        <a href="#" className="remove-pin__link">Remove from pins</a>
