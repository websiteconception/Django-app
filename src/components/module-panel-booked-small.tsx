...
const StyledModulePanelBookedSmall = styled.div<IStyledProps>`
  position: relative;
  border-radius: 6px;
...
class ModulePanelBookedSmall extends Component<IProps, State> {
      ...
      <StyledModulePanelBookedSmall>
        ...
        <div className="booking-panel">
          ...
          <label className="add-guest__controls-container">
            ...
            <input className="email-input" placeholder="Mon 23 Feb - Wed 27 Feb" onClick={this.showDatePicker}/>
          </label>
          ...
          <div className="pricing-breakdown">
            <p className="pricing-total">Total (USD)</p>
            <p className="pricing-total">$0000</p>
          </div>
          <div>
...
export default ModulePanelBookedSmall